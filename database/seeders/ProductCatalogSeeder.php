...
class ProductCatalogSeeder extends Seeder
{
    ...
    private function seedServices(): void
    {
        ...
        // [sku, name, cost, price]
        $rows = [
            ['SRV-EXAMEN', 'Examen visual', 0, 35000],
            ['SRV-ARREGLO', 'Arreglo de gafas', 0, 20000],
            ['SRV-CAMBIO-LENTES', 'Cambio de lentes', 0, 30000],
            ['SRV-REPARACION-PATICA', 'Reparación de pática', 10000, 25000],
            ['SRV-LENSOMETRIA', 'Lensometría', 0, 0],
        ];
        foreach ($rows as [$sku, $name, $cost, $price]) {
            $this->upsert($sku, [
    ...
    private function seedLenses(): void
    {
        ...
        $rows = [
            ['ML-001', 'Monofocal', 'Terminado (Stock)', 'Material 1.56', 'Sin Filtro (Claro)', 6000],
            ['ML-002', 'Monofocal', 'Terminado (Stock)', 'Material 1.56', 'Blue Cut', 20000],
            ['ML-003', 'Monofocal', 'Terminado (Stock)', 'Material 1.56', 'Foto Blue Cut', 50000],
            ['ML-004', 'Monofocal', 'Terminado (Stock)', 'Policarbonato', 'Sin Filtro (Claro)', 13000],
            ['ML-005', 'Monofocal', 'Terminado (Stock)', 'Policarbonato', 'Blue Cut', 50000],
            ['ML-006', 'Monofocal', 'Terminado (Stock)', 'Policarbonato', 'Foto Blue Cut', 110000],
            ['ML-007', 'Monofocal', 'Rango Extendido', 'CR-39', 'Sin Filtro (Claro)', 12000],
            ['ML-008', 'Monofocal', 'Rango Extendido', 'CR-39', 'Blue Cut', 50000],
            ['ML-009', 'Monofocal', 'Rango Extendido', 'Material 1.56', 'Foto Blue Cut', 80000],
            ['ML-010', 'Monofocal', 'Rango Extendido', 'Policarbonato', 'Sin Filtro (Claro)', 30000],
            ...
            ['ML-014', 'Monofocal', 'Tallado Convencional', 'CR-39', 'Sin Filtro (Claro)', 20000],
            ...
            ['ML-017', 'Monofocal', 'Tallado Convencional', 'Policarbonato', 'Sin Filtro (Claro)', 65000],
            ...
            ['ML-023', 'Monofocal', 'Tallado Convencional', 'Material 1.74', 'Sin Filtro (Claro)', 250000],
            ['ML-024', 'Monofocal', 'Digital Plus (Freeform)', 'CR-39', 'Sin Filtro (Claro)', 74000],
            ...
            ['ML-027', 'Monofocal', 'Digital Plus (Freeform)', 'Policarbonato', 'Sin Filtro (Claro)', 84000],
            ...
            ['ML-035', 'Bifocal', 'Terminado (Stock)', 'Material 1.56', 'Sin Filtro (Claro)', 8000],
            ['ML-036', 'Bifocal', 'Terminado (Stock)', 'Material 1.56', 'Blue Cut', 65000],
            ['ML-037', 'Bifocal', 'Terminado (Stock)', 'Material 1.56', 'Foto Blue Cut', 110000],
            ['ML-038', 'Bifocal', 'Tallado Convencional', 'Material 1.56', 'Sin Filtro (Claro)', 25000],
            ...
            ['ML-041', 'Bifocal', 'Tallado Convencional', 'Policarbonato', 'Sin Filtro (Claro)', 70000],
            ['ML-042', 'Bifocal', 'Duo / Invisible (Freeform)', 'CR-39', 'Sin Filtro (Claro)', 74000],
            ['ML-043', 'Bifocal', 'Duo / Invisible (Freeform)', 'Material 1.56', 'Blue Cut', 105000],
            ['ML-044', 'Bifocal', 'Duo / Invisible (Freeform)', 'Material 1.56', 'Foto Blue Cut', 126000],
            ['ML-045', 'Bifocal', 'Duo / Invisible (Freeform)', 'Policarbonato', 'Sin Filtro (Claro)', 84000],
            ['ML-046', 'Bifocal', 'Duo / Invisible (Freeform)', 'Policarbonato', 'Blue Cut', 116000],
            ['ML-047', 'Bifocal', 'Duo / Invisible (Freeform)', 'Policarbonato', 'Foto Blue Cut', 174000],
            ['ML-048', 'Bifocal', 'Duo / Invisible (Freeform)', 'Material 1.61', 'Blue Cut', 137000],
            ['ML-049', 'Bifocal', 'Duo / Invisible (Freeform)', 'Material 1.67', 'Blue Cut', 195000],
            ['ML-050', 'Bifocal', 'Duo / Invisible (Freeform)', 'Material 1.67', 'Foto Blue Cut', 242000],
            ['ML-051', 'Bifocal', 'Duo / Invisible (Freeform)', 'Material 1.74', 'Blue Cut', 420000],
            ['ML-052', 'Progresivo', 'Terminado (Stock)', 'Material 1.56', 'Sin Filtro (Claro)', 30000],
            ['ML-053', 'Progresivo', 'Terminado (Stock)', 'Material 1.56', 'Blue Cut', 65000],
            ['ML-054', 'Progresivo', 'Terminado (Stock)', 'Material 1.56', 'Foto Blue Cut', 100000],
            ['ML-055', 'Progresivo', 'Tallado Convencional', 'Material 1.56', 'Sin Filtro (Claro)', 40000],
            ...
            ['ML-058', 'Progresivo', 'Tallado Convencional', 'Policarbonato', 'Sin Filtro (Claro)', 90000],
            ['ML-059', 'Progresivo', 'Zoom Mira (Freeform)', 'CR-39', 'Sin Filtro (Claro)', 83000],
            ['ML-060', 'Progresivo', 'Zoom Mira (Freeform)', 'Material 1.56', 'Blue Cut', 125000],
            ['ML-061', 'Progresivo', 'Zoom Mira (Freeform)', 'Material 1.56', 'Foto Blue Cut', 154000],
            ['ML-062', 'Progresivo', 'Zoom Mira (Freeform)', 'Policarbonato', 'Sin Filtro (Claro)', 104000],
            ['ML-063', 'Progresivo', 'Zoom Mira (Freeform)', 'Policarbonato', 'Blue Cut', 143000],
            ['ML-064', 'Progresivo', 'Zoom Mira (Freeform)', 'Policarbonato', 'Foto Blue Cut', 201000],
            ['ML-065', 'Progresivo', 'Zoom Mira (Freeform)', 'Material 1.61', 'Blue Cut', 147000],
            ['ML-066', 'Progresivo', 'Zoom Mira (Freeform)', 'Material 1.67', 'Blue Cut', 221000],
            ['ML-067', 'Progresivo', 'Zoom Mira (Freeform)', 'Material 1.67', 'Foto Blue Cut', 273000],
            ['ML-068', 'Progresivo', 'Zoom Mira (Freeform)', 'Material 1.74', 'Blue Cut', 441000],
            ['ML-069', 'Progresivo', 'Zoom Mira (Freeform)', 'Material 1.74', 'Foto Blue Cut', 557000],
        ];
