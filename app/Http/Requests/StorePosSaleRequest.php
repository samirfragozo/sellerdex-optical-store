...
class StorePosSaleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'armados.*.lens.unit_price' => ['required', 'integer', 'min:0', 'max:100000000'],
            'armados.*.lens.unit_cost' => ['nullable', 'integer', 'min:0', 'max:100000000'],
            ...
            'armados.*.combo.include_pano' => ['boolean'],
            'armados.*.combo.estuche' => ['nullable', 'in:small,large'],
