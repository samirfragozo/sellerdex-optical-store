    ...
    >
        ...
        <div v-if="armados.length > 0" class="mb-3 flex flex-col gap-2">
            ...
            >
                ...
                <button
                    type="button"
                    class="flex w-full items-center justify-between rounded-md px-3 py-2 text-left text-sm font-medium outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
